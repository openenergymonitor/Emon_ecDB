...
var customtablefields = {
    ...
    {
        'draw': function (row,field) { 
          var icon = 'icon-eye-file'; if (table.fields[field].icon) icon = table.fields[field].icon;
          return "<a href='"+table.data[row][field]+"' ><i class='"+icon+"' ></i></a>" 
        }
    },
    
    'textprice':
    {
        'draw': function (row,field) { return "£"+(1*table.data[row][field]).toFixed(2); },
